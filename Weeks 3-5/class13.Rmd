...
### Warmup:
1. Concise & accurate labels
1. Data point formatting (colour, size etc) helps reader note important components
1. Axis labels& scales simplify reading
1. Trend or patterns descernible from data shown
1. Legend can help simplify trends as well.   
...
- <<strong, whatever type of motivation is creating this trend is irrelevant; however the graph doesn't show population size or any measure of error. Additionally, the x-axis scale biases the data toward observation of a very small trend.>>
...
- <<Yes, trend is positive. Axes (scales, labels) does not demonstrate this well>>

- Main takeaway: interpret,Summarize the main takeaway from this question/discussion here
...
- <<Shows the opposite trend can be observed. The y axis was deceptive.>>
